...
return [
    ...
    */
    ...
    'exist-product' => 'O produto :attribute não encontrado no banco de dados',
    'exist-product-in-lake' => "O produto :attribute já se encontra importado para essa loja",
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        ...
        'month' => 'mês',
        'name' => 'nome',
        'network_id' => 'código da rede',
        'type_id' => 'tipo do fluxo',
